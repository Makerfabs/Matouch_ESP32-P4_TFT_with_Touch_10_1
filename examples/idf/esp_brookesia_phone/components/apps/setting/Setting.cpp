...
AppSettings::AppSettings():
    ESP_Brookesia_PhoneApp("Settings", &img_app_setting, false, true, true),                  // auto_resize_visual_area
...
void AppSettings::extraUiInit(void)
{
    ...
    lv_label_set_text(ui_LabelPanelPanelScreenSettingAbout2, "Matoch_ESP32-P4_TFT_with_Touch_10_1");
